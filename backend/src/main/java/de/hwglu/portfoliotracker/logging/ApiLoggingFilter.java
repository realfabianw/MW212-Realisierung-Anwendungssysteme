// package de.hwglu.portfoliotracker.logging;
...
// BufferedRequestWrapper bufferedRequest = new
// BufferedRequestWrapper(httpServletRequest);
// BufferedResponseWrapper bufferedResponse = new
// BufferedResponseWrapper(httpServletResponse);
// String requestId = requestMap.containsKey(requestIdParamName) ?
// requestMap.get(requestIdParamName)
...
// ").append(", parameters=")
// .append(requestMap).append(",
// body=").append(bufferedRequest.getRequestBody())
